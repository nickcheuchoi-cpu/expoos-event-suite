...
export default function ResourcePlanning() {
  ...
  useEffect(() => { setMatchState("idle"); setScanCount(0); }, [event.id]);

  // Run the matching scan
  useEffect(() => {
  ...
  // Show candidates only once results are in (or if already assigned on a prior visit)
  const showCandidates = matchState === "matched" || !!assignedCandidateName;
  ...
  return (
    <div className="space-y-6 animate-slide-up">
      ...
      <div className="glass-card-elevated overflow-hidden">
        <div className="p-4 border-b border-border flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-foreground">Staff Alert</span>
          </div>
          <div className="badge-ai"><Zap className="w-2.5 h-2.5" /> AI Matching</div>
        </div>

        {/* idle + matching: two-col (WhatsApp | system response) */}
        {matchState !== "matched" && (
          <div className="p-5">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col justify-center gap-3">
                ...
                {matchState === "idle" && (
                  <button
                    onClick={() => setMatchState("matching")}
                  ...
                  >
                    <Users className="w-4 h-4" /> Find replacement
                  </button>
                )}
        ...
        {/* matched: compact success banner */}
        {matchState === "matched" && (
          <div className="p-5 animate-slide-up">
            <div className="flex items-center justify-between p-3 rounded-lg border border-success/30 bg-success/5">
              ...
              <button
                onClick={() => { setMatchState("idle"); setScanCount(0); }}
      ...
      {/* Candidates + match breakdown — hidden until results are in */}
      {showCandidates && (
