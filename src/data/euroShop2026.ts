...
export const euroShop2026Event: EventData = {
  ...
  deliverySchedule,
  staffAlert: {
    workerName: "Mark Jansen",
    workerInitials: "MJ",
    senderSubtitle: "last seen today at 06:42",
    role: "Senior Builder",
    message: "Hey guys, really sorry. Woke up sick this morning, fever won't go down. Can't make it to the build tomorrow. 🤒",
    time: "06:43",
  },
  supplierAlert: {
    supplierName: "Van Dijk Transport",
    supplierInitials: "VD",
    senderSubtitle: "last seen today at 07:18",
    message: "Hi, unfortunately our truck had a breakdown on the A2 near Utrecht. Delivery of LED Wall Panels and Flooring will be delayed by 2 days. Very sorry for the inconvenience. 🚛",
    time: "07:12",
    impactLabel: "2 deliveries delayed",
    impactDetail: "LED Wall Panels · Flooring — 2-day slip, build buffer reduced to 0",
    draftedReply: "Hi Van Dijk, understood. Please confirm the new delivery date ASAP — we need arrival before 14:00 to keep the build on schedule. Send written confirmation when possible. Thanks.",
    sentConfirmation: "Reply sent to Van Dijk Transport. Awaiting delivery confirmation. Team notified of 2-day delay.",
  },
  candidates,
  matchBreakdown,
  shifts,
